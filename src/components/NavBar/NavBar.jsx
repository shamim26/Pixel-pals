...
const NavBar = () => {
  ...
  return (
    <div className="flex relative items-center justify-between px-6 md:px-16 bg-transparent">
      <div>
      ...
      >
        ...
        <Link to="">Blogs</Link>
        <button className="py-3 px-5 text-black md:ml-60 bg-white rounded-3xl hover:shadow-xl hover:bg-secondary duration-300">
